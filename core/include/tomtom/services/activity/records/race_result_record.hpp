// ============================================================================
// race_result_record.hpp - Race result record (Tag 0x3D)
// ============================================================================
#pragma once
...
#pragma pack(pop)
    ...
    struct RaceResultRecord : ActivityRecord, RaceResultRecordData
    {
        ...
        const char *recordName() const override { return "RaceResult"; }
        size_t recordSize() const override { return sizeof(RaceResultRecordData); }
    };
