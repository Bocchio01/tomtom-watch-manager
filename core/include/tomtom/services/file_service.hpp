...
namespace tomtom::services
{
    ...
    {
    public:
        explicit FileService(std::shared_ptr<protocol::runtime::PacketHandler> packet_handler);
         ...
         */
        std::vector<uint8_t> readFile(FileId file_id);
         ...
         */
        void writeFile(FileId file_id, const std::vector<uint8_t> &data);
    ...
    private:
         ...
         */
        void openFile(FileId file_id, FileOpenMode mode);
         ...
         */
        void closeFile(FileId file_id, bool check_error = true);
